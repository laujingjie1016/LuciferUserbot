#Made By @broken_identity. Keep Credit if you are gonna copy paste it. LOL NOOBS....
...
@borg.on(admin_cmd(pattern=r"rshayri$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
